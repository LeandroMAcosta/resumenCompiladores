...
\newcounter{neq}
\providecommand{\lang}[1]{\langle#1\rangle}
\providecommand{\semAGU}[1]{\LEFT#1\RIGHT}
\providecommand{\semsAGU}[1]{\LEFT#1\RIGHTS}
\providecommand{\semsp}[1]{\LEFT#1\RIGHTSP}
\providecommand{\ifthenelse}[3]{\textbf{if}\;#1\;\textbf{then}\;#2\;\textbf{else}\;#3}
\providecommand{\newvar}[2]{\textbf{newvar}\;#1\;\textbf{in}\;#2}
\providecommand{\while}[2]{\textbf{while}\;#1\;\textbf{do}\;#2}
\providecommand{\catch}[2]{\textbf{catchin}\;#1\;\textbf{with}\;#2}
\providecommand{\poset}[2]{$(#1, \; #2)$ poset}
\providecommand{\brace}[1]{\{ \{#1\} \}}

\newcommand{\PN}{\par\noindent}
\newcommand{\LEFT}{\llbracket}
\newcommand{\RIGHT}{\rrbracket}
\newcommand{\RIGHTS}{\rrbracket \sigma}
\newcommand{\RIGHTSP}{\rrbracket \sigma'}
\newcommand{\SIGMA}{$\sigma$}
\newcommand{\sigmab}{\Sigma_{\bot}}
\newcommand{\SUP}{\bigsqcup_{i=0}^{\infty}}
\newcommand{\bottom}{\underline{\bot}}
\newcommand{\abort}{\textbf{abort}}
\newcommand{\skipp}{\textbf{skip}}
\newcommand{\fail}{\textbf{fail}}
\newcommand{\entonces}{$\Rightarrow$}
\newcommand{\sii}{\; sii \;}
\newcommand{\lterm}{\iota_{term}}
\newcommand{\labort}{\iota_{abort}}
\newcommand{\lout}{\iota_{out}}
\newcommand{\lin}{\iota_{in}}
\newcommand{\lbot}{\iota_{\bot}}
\newcommand{\lnorm}{\iota_{norm}}
\newcommand{\labnorm}{\iota_{abnorm}}
\newcommand{\cp}{\; . \;}
